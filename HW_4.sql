...
ALTER TABLE employees ADD COLUMN salarywithcomm NUMERIC(8, 4);

set sql_safe_updates = 0;

UPDATE employees
SET salarywithcomm = salary + salary * 0.15;

ALTER TABLE employees MODIFY COLUMN salarywithcomm DECIMAL(10, 2); -- modified this condition as received an error: Error Code: 1264. Out of range value for column 'salarywithcomm' at row 1
...
ALTER TABLE employees ADD COLUMN chk_email VARCHAR(128);
